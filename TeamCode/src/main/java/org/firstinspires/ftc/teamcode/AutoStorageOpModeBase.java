...
public abstract class AutoStorageOpModeBase extends CommandOpMode {
    ...
    public AutoStorageOpModeBase(double turnAngle){
    ...
    public void initialize(){
        ...
        schedule(
                new SequentialCommandGroup(
                        ...
                        new TurnInPlace(drive, turnAngle, telemetry),
